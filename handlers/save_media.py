...
async def save_batch_media_in_channel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Tamilprime_{str_to_b64(str(SaveMessage.message_id))}"
        await editable.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Open Link", url=share_link)],
                 [InlineKeyboardButton("Bots Channel", url="https://t.me/Tamil_prime"),
                  InlineKeyboardButton("Support Group", url="https://t.me/Tamil_prime")]]
            ),
            disable_web_page_preview=True
        )
        await bot.send_message(
